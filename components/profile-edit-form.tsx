    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="space-y-2">
        <Label htmlFor="memberSince" className="flex items-center gap-2">
          <TimerReset className="h-4 w-4 text-accent" /> عضو از سال
        </Label>
        <Input
          id="memberSince"
    ...
    <div className="grid gap-4 md:grid-cols-2">
      <div className="space-y-2">
        <Label htmlFor="email" className="flex items-center gap-2">
          <Mail className="h-4 w-4 text-accent" /> ایمیل اصلی
        </Label>
        <Input
          id="email"
          type="email"
      ...
      <div className="space-y-2">
        <Label htmlFor="phone" className="flex items-center gap-2">
          <Phone className="h-4 w-4 text-accent" /> شماره موبایل
        </Label>
      ...
      <div className="space-y-2 md:col-span-2">
        <Label htmlFor="shippingNote" className="flex items-center gap-2">
          <MessageSquareText className="h-4 w-4 text-accent" /> یادداشت ارسال پیش‌فرض
        </Label>
        <Textarea
          id="shippingNote"
    ...
    <div className="grid gap-4 md:grid-cols-2">
      <div className="space-y-2">
        <Label htmlFor="colorProfile" className="flex items-center gap-2">
          <Palette className="h-4 w-4 text-accent" /> پروفایل رنگی ترجیحی
        </Label>
        <Input
          id="colorProfile"
      ...
      <div className="space-y-2">
        <Label htmlFor="packaging" className="flex items-center gap-2">
          <Printer className="h-4 w-4 text-accent" /> نوع بسته‌بندی
        </Label>
        <Input
          id="packaging"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-foreground-muted">ارسال جزئیات از آماده‌سازی تا تحویل</p>
            </div>
          </div>
          <input
            id="emailUpdates"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-foreground-muted">اطلاع‌رسانی آماده‌سازی و ارسال از طریق پیامک</p>
            </div>
          </div>
          <input
            id="smsUpdates"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-foreground-muted">اطلاع از کمپین‌های ویژه چاپ عکس</p>
            </div>
          </div>
          <input
            id="promoOffers"
