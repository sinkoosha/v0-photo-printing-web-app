        ...
        {categories.map((category) => (
          <article key={category.name} className="group flex flex-col items-center text-center">
            <div className="relative flex h-32 w-32 items-center justify-center rounded-full bg-white shadow-[0_25px_40px_rgba(59,47,42,0.18)] ring-1 ring-[#E9E1DA]/80 transition-transform duration-200 before:absolute before:inset-[12%] before:-z-10 before:rounded-full before:bg-[radial-gradient(circle_at_top,_#ffffff,_#f5e9df_65%,_#ecd9ca)] before:opacity-0 before:transition-opacity before:duration-200 group-hover:-translate-y-1 group-hover:before:opacity-100">
              <span className="pointer-events-none absolute -bottom-8 left-1/2 h-3 w-20 -translate-x-1/2 rounded-full bg-[#c9bbae]/60 blur-[8px] transition duration-200 group-hover:scale-110 group-hover:bg-[#c09973]/50" aria-hidden="true" />
            ...
            <span className="mt-2 h-[2px] w-10 rounded-full bg-[#E9E1DA]" aria-hidden="true" />
          </article>
        ))}
      </div>
    </section>
