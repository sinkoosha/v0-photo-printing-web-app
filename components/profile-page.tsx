        ...
        <div className="container py-12">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-sm text-muted-foreground">{profileData.bio}</p>
            </div>
            <Card className="p-5 shadow-sm backdrop-blur-sm">
              <div className="flex flex-col gap-2 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span className="text-muted-foreground">پشتیبان: {profileData.secondaryPhone}</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <Card className="space-y-4 p-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border border-dashed border-border/60 p-4">
                  <p className="mb-1 text-xs text-muted-foreground">آخرین ورود</p>
                  <p className="font-medium">۱۲ خرداد ۱۴۰۳ · تهران</p>
                </div>
                <div className="rounded-lg border border-dashed border-border/60 p-4">
                  <p className="mb-1 text-xs text-muted-foreground">روش ورود فعال</p>
                  <p className="font-medium">رمز یکبارمصرف پیامکی + رمز عبور</p>
                </div>
                <div className="rounded-lg border border-dashed border-border/60 p-4">
                  <p className="mb-1 text-xs text-muted-foreground">فضای گالری</p>
                  <p className="font-medium">۱٫۸ گیگابایت از ۵ گیگابایت</p>
                </div>
                <div className="rounded-lg border border-dashed border-border/60 p-4">
                  <p className="mb-1 text-xs text-muted-foreground">اشتراک فعال</p>
                  <p className="font-medium">{profileData.plan}</p>
                </div>
                <div className="rounded-lg border border-dashed border-border/60 p-4">
                  <p className="mb-1 text-xs text-muted-foreground">کانال‌های اعلان فعال</p>
            ...
            <Card className="space-y-4 p-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-1 rounded-lg border border-border/60 p-4">
                  ...
                  <p className="text-xs text-muted-foreground">این پروفایل روی تمامی چاپ‌های جدید اعمال می‌شود.</p>
                </div>
                <div className="space-y-1 rounded-lg border border-border/60 p-4">
                  <p className="text-xs text-muted-foreground">حاشیه دلخواه</p>
                  <p className="font-medium">{profileData.borderStyle}</p>
                  <p className="text-xs text-muted-foreground">انتخاب مناسب برای قاب‌بندی هنری و آلبوم.</p>
                </div>
                <div className="space-y-1 rounded-lg border border-border/60 p-4">
                  <p className="text-xs text-muted-foreground">ویرایش خودکار</p>
                  <p className="font-medium">{profileData.autoEnhance}</p>
                  <p className="text-xs text-muted-foreground">تنظیم روشنایی و نویزگیری خودکار برای پرتره‌ها.</p>
                </div>
                <div className="space-y-1 rounded-lg border border-border/60 p-4">
                  <p className="text-xs text-muted-foreground">نوع بسته‌بندی</p>
                  <p className="font-medium">{profileData.packaging}</p>
                  <p className="text-xs text-muted-foreground">برای تحویل هدیه و تجربه بازگشایی جذاب.</p>
                </div>
              </div>
            ...
            <Card className="space-y-4 p-6">
              ...
              <div className="space-y-3">
                <div className="rounded-lg border border-border/60 p-4">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">**** **** **** ۵۴۳۲ · اعتبار تا ۰۴/۱۴۰۵</p>
                </div>
